function IconSunset() {
    return (
        <svg fill="currentColor" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 30 30" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
            
            <path className="sunset__circle"
                d="M9.08,15.47
                ...
                S9.08,14.68,9.08,15.47z"></path>
                    
            <g className="sunset__beams">
                <path className="sunset__beam-9"
                    ...
                    C2.98,15.97,2.88,15.74,2.88,15.47z"></path>
                <path className="sunset__beam-10-5"
                    d="M6.17,7.61c0-0.28,0.08-0.51,0.25-0.68c0.2-0.2,0.43-0.3,0.7-0.3c0.29,0,0.51,0.1,0.68,0.3
                    l1.62,1.63c0.46,0.44,0.46,0.89,0,1.35c-0.19,0.19-0.4,0.28-0.65,0.28c-0.22,0-0.44-0.09-0.68-0.28L6.43,8.29
                    C6.26,8.11,6.17,7.88,6.17,7.61z"></path>
                <path className="sunset__beam-12"
                    d="M14.04,6.66V4.33c0-0.27,0.1-0.5,0.29-0.69s0.42-0.29,0.69-0.29c0.27,0,0.5,0.1,0.69,0.29
                    s0.29,0.42,0.29,0.69v2.32c0,0.27-0.1,0.5-0.29,0.69c-0.19,0.19-0.42,0.29-0.69,0.29c-0.27,0-0.5-0.1-0.69-0.29
                    C14.13,7.15,14.04,6.93,14.04,6.66z"></path> 
                <path className="sunset__beam-13-5"
                    d="M20.31,9.24c0-0.28,0.09-0.51,0.26-0.67l1.63-1.63c0.16-0.2,0.39-0.3,0.68-0.3
                    ...
                    c-0.26,0-0.48-0.09-0.66-0.28C20.4,9.74,20.31,9.51,20.31,9.24z"></path>
                <path className="sunset__beam-15"
                    d="M22.9,15.47c0-0.27,0.09-0.49,0.26-0.67
            ...
            <path className="sunset__bar"
                d="M8.14,20.89c0-0.26,0.1-0.49,0.3-0.69c0.18-0.18,0.41-0.27,0.68-0.27h3.22
                ...
                c-0.12,0.09-0.23,0.09-0.33,0l-3.08-2.84h-2.6c-0.27,0-0.5-0.1-0.69-0.29C8.24,21.39,8.14,21.16,8.14,20.89z"></path> 
        </svg>
    )
};
